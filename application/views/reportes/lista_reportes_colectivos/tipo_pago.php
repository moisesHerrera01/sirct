        ...
        if(anio!="" && tipo_pago!="" &&  (($("#mes").val()!="0" && document.getElementById('radio_mensual').checked==true)
        	...
        	|| ($("#fecha_inicio").val()!="" && $("#fecha_fin").val()!="" && document.getElementById('radio_periodo').checked==true)
          	...
          	if(document.getElementById('radio_pdf').checked==true && tipo==""){
          		var param = { 'anio' : anio, 'tipo' : type, 'value' : value, 'value2' : value2, 'tipo_pago' : tipo_pago, 'id_delegado' : id_delegado, 'report_type' : 'pdf' };
        		OpenWindowWithPost(url, param, "_blank");
          	}else if(document.getElementById('radio_excel').checked==true && tipo==""){
          		var param = { 'anio' : anio, 'tipo' : type, 'value' : value, 'value2' : value2, 'tipo_pago' : tipo_pago, 'id_delegado' : id_delegado, 'report_type' : 'excel' };
        		OpenWindowWithPost(url, param, "_blank");
          	}else{
          		var param = { 'anio' : anio, 'tipo' : type, 'value' : value, 'value2' : value2, 'tipo_pago' : tipo_pago, 'id_delegado' : id_delegado, 'report_type' : 'html' };
            ...
            <div class="col-lg-4" style="display: block;" id="cnt_form">
                <div class="card">
                    ...
                    <div class="card-body b-t">
                        ...
                        <div class="form-group">
                            <h5>Tipo pago: <span class="text-danger"></span></h5>
                            <select id="tipo_pago" name="tipo_pago" class="select2" onchange="" style="width: 100%" >
                                <option value="0">[Seleccione]</option>
                                <option class="m-l-50" value="1">En el momento</option>
                                <option class="m-l-50" value="2">Diferido</option>
                            </select>
                        </div>
