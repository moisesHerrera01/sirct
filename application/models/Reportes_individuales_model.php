...
class Reportes_individuales_model extends CI_Model {
	...
	function registros_relaciones_individuales($data){
		$this->db->select("
			(SELECT COUNT(*) FROM sct_personaci AS p2 WHERE p2.id_personaci = ecc.id_personaci AND p2.sexo_personaci = 'M') AS cant_masc,
			(SELECT COUNT(*) FROM sct_personaci AS p2 WHERE p2.id_personaci = ecc.id_personaci  AND p2.sexo_personaci = 'F') AS cant_feme,
			...
			(SELECT COUNT(*) FROM sct_personaci AS p2 WHERE p2.id_personaci = ecc.id_personaci  AND p2.discapacidad_personaci = '1') AS discapacidadci,
			ecc.*, p.*, emp.*, est.*, ciiu.*")
